...
public class GeradorGrafico {
    ...
    public void addValor(double vezes, String ordem, String palavra){
        dadoBarra.addValue(vezes, palavra, ordem);
        //dadoPizza.setValue(linha, media);
    }
    private void criaGrafico(){
        graficoBarra = ChartFactory.createBarChart("Contagem de Palavras", "Palavras", "Vezes", dadoBarra, PlotOrientation.VERTICAL, true, true, true);
